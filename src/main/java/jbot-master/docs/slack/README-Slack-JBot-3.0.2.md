...
3. Paste the token in [application.properties](/application.properties) file.  
...
All the code for your bot goes in [SlackBot](/example/jbot/slack/SlackBot.java) class which
...
* __Slash Command Handler__ &rArr; Annotate your [class](/example/jbot/slack/SlackSlashCommand.java)
  with Spring's `@Controller` and have a [method](/example/jbot/slack/SlackSlashCommand.java#onReceiveSlashCommand)
...
In __Incoming Webhooks__, your [application](/example/jbot/slack/SlackWebhooks.java) `POST` 
...
You can directly clone this project and use [jbot-example](/) or you can include it as a maven/gradle 
...
[jbot-example](/example/jbot/JBotApplication.java) to learn more.
...
3. Paste the above tokens/urls in [application.properties](/application.properties) file.    
